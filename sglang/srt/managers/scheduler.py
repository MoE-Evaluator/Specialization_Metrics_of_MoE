...
class Scheduler(
    ...
    def expert_distribution_handle(self, recv_req: ExpertDistributionReq):
        ...
        if action == ExpertDistributionReqType.START_RECORD:
            ...
            data = get_global_expert_distribution_recorder().dump_record(output_mode="object")
            return ExpertDistributionReqOutput(data=data)
        elif action == ExpertDistributionReqType.GET_STATUS:
            data = get_global_expert_distribution_recorder().get_status(output_mode="object")
            return ExpertDistributionReqOutput(data=data)
        else:
